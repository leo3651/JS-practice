...
const showRecipe = async function() {
    try {
        ...
        <figure class="recipe__fig">
          <img src="${_modelJs.state.recipe.imageUrl}" alt="${_modelJs.state.recipe.title}" class="recipe__img" />
          <h1 class="recipe__title">
            <span>${_modelJs.state.recipe.title}</span>
          </h1>
        </figure>
        ...
        <div class="recipe__details">
          ...
          <div class="recipe__info">
            ...
            <span class="recipe__info-data recipe__info-data--minutes">${_modelJs.state.recipe.cookingTime}</span>
          ...
          <div class="recipe__info">
            ...
            <span class="recipe__info-data recipe__info-data--people">${_modelJs.state.recipe.servings}</span>
        ...
        <div class="recipe__ingredients">
          ...
          ${_modelJs.state.recipe.ingredients.reduce((acc, ing)=>{
            acc += `
        ...
        <div class="recipe__directions">
          ...
          <p class="recipe__directions-text">
            ...
            <span class="recipe__publisher">${_modelJs.state.recipe.publisher}</span>. Please check out
            directions at their website.
          </p>
          <a
            class="btn--small recipe__btn"
            href="${_modelJs.state.recipe.sourceUrl}"
            target="_blank"
          >
